...
export class QuestionService {
    ...
    swapOrder(question: Question, otherQuestion: Question): Observable<{ results: Question[] }> {
        const body = {
            question_id: question.id,
            other_question_id: otherQuestion.id
        };
        return this.http.post<{ results: Question[] }>(`${this.apiUrl}-swap/`, body, { withCredentials: true });
    }
