...
export class SectionService {
    ...
    swapOrder(section: Section, otherSection: Section): Observable<{ results: Section[] }> {
        const body = {
            section_id: section.id,
            other_section_id: otherSection.id
        };
        return this.http.post<{ results: Section[] }>(`${this.apiUrl}-swap/`, body, { withCredentials: true });
    }
