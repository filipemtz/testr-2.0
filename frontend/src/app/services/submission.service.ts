...
export class SubmissionService {
    ...
    getSubmission(questionId: number): Observable<any> {
        return this.http.get(`${this.apiUrl}/get/${questionId}`);
    }
    ...
    // retorna todas as submissões feitas por um aluno em um curso
    submissionsFromCourse(courseId: number): Observable<any> {
        return this.http.get(`${this.apiUrl}/from_course/${courseId}`);
    }
