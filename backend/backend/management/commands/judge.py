...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if options["rerun"]:
            Submission.objects.update(status=SubmissionStatus.WAITING_EVALUATION)
            ...
            if len(submissions) == 0:
                ...
                if options["verbose"]:
                    print(
                        ...
                        "STUDENT:",
                        selected_submission.student.first_name,
                        selected_submission.student,
                        "QUESTION:",
                        selected_submission.question,
                    )
