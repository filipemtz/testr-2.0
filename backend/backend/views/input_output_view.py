...
class InputOutputViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return InputOutput.objects.filter(question__section__course__teachers=user) | InputOutput.objects.filter(question__section__course__students=user, visible=True)